...
<head>
   <meta charset="UTF-8">
   <title>Choxe</title>
   <link rel="stylesheet" href="../CSS/selectListUser.css">
</head>
         ...
         <div class="list_select_users">
            ...
            <div class="left_container">
               <ul class="list-group">
                  ...
                  <li class="list-group-item"><a id="link_users" href="ttnd.php"><i style="font-size:22px" class=" fa-regular fa-circle-user"></i>ㅤThông
                        tin
                        tài khoản</a></a></li>
                  ...
                  <li class="list-group-item"><a id="link_users" href="qldh.php"><i style="font-size:22px" class="fa-solid fa-list"></i>ㅤQuản lý tin
                        đăng</a></li>
                  <li class="list-group-item"><a id="link_users" href="qldh.php"><i style="font-size:22px" class="fa-solid fa-receipt"></i>ㅤQuản lý
                        đơn hàng</a></li>
                  ...
                  <li class="list-group-item"><a id="link_users" href=""><i style="font-size:22px" class="fa-solid fa-shop"></i>ㅤĐăng ký
                        salon</a></li>
                  <li class="list-group-item" id="users_ttnd"><a id="users_ttnd" href=""><i style="font-size:22px" class="fa-solid fa-lock"></i>ㅤĐổi mật khẩu
                     </a></li>
                        ...
                        <div class="change-password-container">
                           <form class="select-password">
                              <div class="field">
                                 <div class="control-field">
                                    <div class="text-input">
                                       <input type="password" class="input_cpass" wire:model.defer="password-old" placeholder="Nhập mật khẩu cũ" id="passworda">
                                       <span class="icon-eye-right">
                                          <i class="icon-eye" id="showPassword" onclick="togglePassword1()"></i>
                                       </span>
                                    </div>
                                 </div>
                              </div>
                              <div class="field">
                                 <div class="control-field">
                                    <div class="text-input">
                                       <input type="password" class="input_cpass" wire:model.defer="password-old" placeholder="Nhập mật khẩu mới" id="passwordb">
                                       <span class="icon-eye-right">
                                          <i class="icon-eye" id="showPassword" onclick="togglePassword2()"></i>
                                       </span>
                                    </div>
                                 </div>
                              </div>
                              <div class="field">
                                 <div class="control-field">
                                    <div class="text-input">
                                       <input type="password" class="input_cpass" wire:model.defer="password-old" placeholder="Nhập lại mật khẩu mới" id="passwordc">
                                       <span class="icon-eye-right">
                                          <i class="icon-eye" id="showPassword" onclick="togglePassword3()"></i>
                                       </span>
                                    </div>
                                 </div>
                              </div>
